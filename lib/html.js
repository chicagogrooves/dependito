...
function generateHtml(graphData, dependencies, recentUpdates) {
...
module.exports.output = function(dependencies, recentUpdates) {

  // Convert data
  var graphData = generateGraphData(dependencies);

  return generateHtml.call(this, graphData, dependencies, recentUpdates);
